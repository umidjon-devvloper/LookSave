 ...
 *
 * Do'kon panelidagi mijoz bilan deyarli bir xil, ikki farq bilan:
 * `X-Store-Id` yo'q va `localStorage` kaliti boshqa — bir brauzerda
...
const REFRESH_KEY = 'looksave.admin.refresh';
